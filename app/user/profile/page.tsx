  ...
  return (
    ...
    <div className="flex flex-col min-h-screen mb-20">
      <header className="flex flex-col lg:flex-row items-center justify-center h-14 p-10 border-b lg:h-20 bg-gray-100/40 dark:bg-gray-800/40">
        <div className="font-semibold">Cyber Cafe Management System: User Profile</div>
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <Input id="dob" placeholder="Date of Birth" type="date" disabled={!isEditing}/>
                </div>
              </div>
              <div className="mt-4">
                ...
                <Input id="password" placeholder="Password" type="password" disabled={!isEditing}/>
              </div>
            </CardContent>
            <CardFooter className="flex flex-row items-center justify-between">
              <Button className="" variant={"ghost"} disabled={!isEditing}>Cancel</Button>
              <Button className="ml-auto" disabled={!isEditing}>Save changes</Button>
            </CardFooter>
          </Card>
        </div>
      </main>
